...
## 11월14일(금) 전이학습 실습 
  - 오전 9시~11시: 이해도 문제 풀이
  - 오전 11시~11:20분: 병충해 나뭇잎 분류 전이학습,  자료에 대한 개요 및 프로세스만 제공
          자료 사이트: https://github.com/bjpublic/DeepLearningProject
  - 11시30~12시: 코드실행하면서 작업합니다. 데이터로더기 및 전이학습 코드로 돌리면서, 값들 확인하는 절차
  - 1시~4시: 조별작업 (병충해 나뭇잎 또는 개인미션, 팀별전체 또는 소규모로 의견맞으시는 분들끼리 미션해도 됩니다.
                                               , 추후bakpak@empas.com 으로 제줄하세요. _ 과정기록한 내용으로(블로그, git, ipynb의 코드설명 다 괜찮습니다. _ )
                                                - 날짜마감없음
